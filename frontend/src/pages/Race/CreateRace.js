...
class CreateRacePage extends Component {
  ...
  render() {
    ...
    const claimings = [
      ...
      { label: "90,000 Libres", value: "90,000 Libres" },
      ...
      { label: "130,000 Ganadores de 1 y 2 primeras", value: "130,000 Ganadores de 1 y 2 primeras" },
      ...
      { label: "260,000 No Ganadores", value: "260,000 No Ganadores" },
